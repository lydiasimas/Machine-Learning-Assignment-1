...
if A11
    ...
    title('Visualization of input vetors and its target values');
    hold on;
...
%     tic
%     b1=[normrnd(repmat([0.35 0.15],10,1),0.15),ones(10,1)];
%     b2=[normrnd(repmat([0.75 0.75],10,1),0.1),-ones(10,1)];
%     b3=[normrnd(repmat([0.0 0.0],10,1),0.1),-ones(10,1)];
%     b4=[normrnd(repmat([0.0 0.6],10,1),0.1),-ones(10,1)];
%     
%     rbf_training=[b1;b2;b3;b4];
%     toc
